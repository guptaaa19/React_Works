//App.js ep04 from namaste react
...
const ResturantCard = (props) => {
    ...
    const {
        ...
        costForTwo,
        deliveryTime,
    } = resData?.data ;   // (?. is optional chaining) 
    return (
    ...
    return(
        <div className="body">
            ...
            <div className="res-container">
                ...
                {/* we are dynamically rendering res-card for each resturants using map function which is production practice...we can also use map function ...we dont need to worry about the number of resturants.  */}
